...
def main_prompt():
    main_prompt = f"""
                ...
                2. If needed, pass the query to RAGagent using the subagents by calling "rag" to receive relevant context.
                ...
                6.While calling for subagents keep the output field empty.
